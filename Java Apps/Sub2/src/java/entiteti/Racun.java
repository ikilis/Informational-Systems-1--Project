...
public class Racun implements Serializable {
    ...
    @Column(name = "idMes")
    private int idMes;
    @OneToMany(mappedBy = "racunNa")
    private List<Transakcija> transakcijaList;
    @OneToMany(mappedBy = "racunSa")
    ...
    public Racun(Integer idRac, float stanje, float dozvMinus, Character status, Date datum, Date vreme, int brTransakcija, int idMes) {
        this.idRac = idRac;
        this.stanje = stanje;
